...
const Register = () => {
	...
	const handleSubmit = async (e) => {
		e.preventDefault()
		//Aqui vai ser uma validação para CASO alguem tente burlar o sistema
		//mas 99% dos casos não vai ter essa validação
		...
		try {
			...
			console.log(
				'resposta completa(é transformado através do JSON.stringify)',
				JSON.stringify(response)
			)
			setSuccess(true)
			//agora poderia dar um clear input fields
		} catch (err) {
			if (!err?.response) {
